...
/**
 * Generates an implementation of a NEWT (a variation of AWT) window for providing a basis for JOGL rendering.
 * GWindow uses the singleton pattern to ensure there is only one application window.
 * 
